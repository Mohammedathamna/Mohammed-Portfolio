# AstroMohammed - Personal Portfolio Website

AstroMohammed is a minimalist, accessible and responsive portfolio template for your personal portfolio website. It is built with Astro and TailwindCSS.
...
```scheme
git clone https://github.com/Mohammedathamna/Mohammed-Portfolio.git
cd astro-zen
```
